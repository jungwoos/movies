...
import 'package:basic_web/podo/Movies.dart';
import 'package:basic_web/util/constants.dart';
      ...
      body: Padding(
        ...
        child:  _loading
          ...
          child: CircularProgressIndicator(
            ...
            :GridView.builder(
          itemCount: movies.result == null ? 0 : movies.result.length,
          ...
          itemBuilder: (BuildContext context, int index){
            Results movie = movies.result[index];
